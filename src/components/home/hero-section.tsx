        ...
        <div className="grid min-h-[calc(100vh-8rem)] items-center gap-12 lg:grid-cols-2">
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative h-[600px]">
              ...
              {/* Floating Badge 1 */}
              <div
                className="absolute top-20 right-0 animate-bounce rounded-full bg-gradient-to-br from-green-500 to-green-600 px-6 py-3 text-sm font-medium text-white shadow-xl"
